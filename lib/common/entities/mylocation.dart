...
MyLocation locationFromJson(String str) =>
    MyLocation.fromJson(json.decode(str));
...
class Geometry {
  ...
  factory Geometry.fromJson(Map<String, dynamic> json) => Geometry(
        location: json["location"] == null
            ? null
            : MyLocationClass.fromJson(json["location"]),
        locationType:
...
class Bounds {
  ...
  factory Bounds.fromJson(Map<String, dynamic> json) => Bounds(
        northeast: json["northeast"] == null
            ? null
            : MyLocationClass.fromJson(json["northeast"]),
        southwest: json["southwest"] == null
            ? null
            : MyLocationClass.fromJson(json["southwest"]),
      );
...
class MyLocationClass {
  ...
  factory MyLocationClass.fromJson(Map<String, dynamic> json) =>
      MyLocationClass(
